...
function LogoutMenu({
  ...
  const handleAppLogout = useCallback(async () => {
    ...
    window.location.href = FULL_LOGOUT_REDIRECT;
  }, [instance]);
  ...
  return (
    <div
      ref={menuRef}
      className="absolute right-0 top-full mt-2 z-50 bg-white rounded-xl shadow-2xl border border-gray-200 w-64 overflow-hidden"
    >
      <div className="px-4 py-2.5 border-b border-gray-100">
        <p className="text-xs font-semibold text-gray-700">Sign out</p>
        <p className="text-[10px] text-gray-400 mt-0.5">Choose how to sign out</p>
      </div>

      <div className="p-1.5">
        <button
          onClick={handleAppLogout}
          className="w-full flex items-start gap-2.5 px-3 py-2.5 rounded-lg text-left hover:bg-gray-50 transition-colors cursor-pointer group"
        >
          <div className="flex-shrink-0 mt-0.5 h-7 w-7 rounded-full bg-orange-50 flex items-center justify-center">
          ...
          <div>
            <p className="text-xs font-medium text-gray-700 group-hover:text-gray-900">Sign out from app only</p>
            <p className="text-[10px] text-gray-400 mt-0.5">Stay signed in to Microsoft</p>
          </div>
        </button>

        <button
          onClick={handleMicrosoftLogout}
          className="w-full flex items-start gap-2.5 px-3 py-2.5 rounded-lg text-left hover:bg-red-50 transition-colors cursor-pointer group"
        >
          <div className="flex-shrink-0 mt-0.5 h-7 w-7 rounded-full bg-red-50 flex items-center justify-center">
          ...
          <div>
            <p className="text-xs font-medium text-gray-700 group-hover:text-red-600">Sign out from Microsoft</p>
            <p className="text-[10px] text-gray-400 mt-0.5">End your Microsoft session entirely</p>
          </div>
        </button>
      </div>
      ...
      <div className="px-1.5 pb-1.5">
        <button
          onClick={onClose}
          className="w-full px-3 py-1.5 text-[11px] font-medium text-gray-400 hover:text-gray-600 hover:bg-gray-50 rounded-lg transition-colors cursor-pointer"
        >
          Cancel
        </button>
      </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="relative">
                  <button
                    ...
                    title="Sign out"
                    className={`ml-1 p-1.5 rounded-md transition-colors cursor-pointer ${
                      showLogoutMenu
